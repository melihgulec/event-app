...
class _EditEventScreenState extends State<EditEventScreen> {
  ...
  void initState() {
    ...
    countryDropdownValue = widget.event.country.id.toString();
    cityDropdownValue = widget.event.city.id.toString();
    eventTypeDropdownValue = widget.event.eventType.id.toString();
    languageDropdownValue = widget.event.language.id.toString();
    participationTypeDropdownValue = widget.event.participationType.id.toString();
    interestDropdownValue = widget.event.interest.id.toString();
    userCommunityRoleDropdownValue = widget.event.community.id.toString();
  }
