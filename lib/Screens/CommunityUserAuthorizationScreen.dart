...
class CommunityUserAuthorizationScreen extends StatefulWidget {
  Community community;

  CommunityUserAuthorizationScreen({Key key, this.community}) : super(key: key);

  @override
  State<CommunityUserAuthorizationScreen> createState() =>
      _CommunityUserAuthorizationScreenState();
}

class _CommunityUserAuthorizationScreenState extends State<CommunityUserAuthorizationScreen> {
  ...
  void SendRole() {
    if(userEmail.text.isNotEmpty && roleDropdownValue.isNotEmpty){
      PostCommunityRole(widget.community.id, userEmail.text, int.parse(roleDropdownValue));
    }else{
        ...
        child: Column(
          ...
          children: [
            Expanded(
              child: Column(
                children: [
                  Text(Texts.communityAuthorizationScreenDescription),
                  WhiteSpaceVertical(),
                  TextFieldWithIcon(
